// Stream detail page — streamer's read-only view of their own submission
// Server component: queries the database directly via Drizzle ORM
// Security: verifies the stream entry belongs to the authenticated user
...
export default async function StreamDetailPage({
  ...
  // Fetch the stream entry with ownership verification
        ...
        <section className="rounded-xl border border-blood-900/40 bg-black/60 p-6 backdrop-blur-md">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-medium text-green-400">{fmt(streamSales)}</p>
            </div>
            <div>
          ...
          <section className="rounded-xl border border-blood-900/40 bg-black/60 p-6 backdrop-blur-md">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-0 sm:grid-cols-2">
              ...
              <div className="mt-3 space-y-3 sm:mt-0">
                ...
                {/* Breaker Payout — streamer's final number */}
