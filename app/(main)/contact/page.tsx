      ...
      <section className="relative py-20 md:py-28 overflow-hidden bg-[#0a0a0a]">
        ...
        <Container className="relative z-10">
          <div className="text-center max-w-3xl mx-auto animate-fade-in-up">
            ...
            <p className="text-xl text-cage-300">Questions? Requests? Let&apos;s Talk</p>
          </div>
        </Container>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="scroll-animate">
              <h2 className="font-heading text-2xl md:text-3xl font-bold text-white uppercase tracking-tight mb-6">
                Let&apos;s Connect
              </h2>
              <p className="text-lg text-cage-300 mb-8 leading-relaxed">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 bg-dark-800/80 border border-gold-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-cage-400 text-sm">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-cage-400 text-sm">For formal inquiries and partnerships</p>
                    <a href="mailto:hello@chicken1of1.com" className="text-gold-400 text-sm hover:text-gold-300 transition-colors duration-200">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-cage-400 text-sm">
                      Catch us live on Whatnot for real-time Q&A
                    </p>
                    <Link href="/live" className="text-gold-400 text-sm hover:text-gold-300 transition-colors duration-200">
                      Watch Live
                    </Link>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto scroll-animate">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <div className="text-lg font-semibold text-gold-400 mb-1">Instagram DMs</div>
                <div className="text-sm text-cage-400">Usually within hours</div>
              </div>
              <div>
                <div className="text-lg font-semibold text-gold-400 mb-1">Email</div>
                <div className="text-sm text-cage-400">Within 24 hours</div>
              </div>
              <div>
                <div className="text-lg font-semibold text-gold-400 mb-1">Live Chat</div>
                <div className="text-sm text-cage-400">During stream times</div>
              </div>
            </div>
          </div>
        </div>
